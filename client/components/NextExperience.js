...
class NextExperience extends Component {
  ...
  componentDidMount() {
    ...
    if (topics[0]) {
      ...
      this.setState({ nextExperiences, componentLoading: false })
    }
  ...
  render() {
    ...
    console.log('this.state.componentLoading', this.state.componentLoading)
    ...
    return (
      <div>
        <h1>Hello world </h1>
        {this.state.componentLoading ? <div> Fetching your next locations! </div> :
          <div>
